 ...
 * @author sm187t
 */
public class TestRunnerWindow extends JFrame {
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(TestRunnerWindow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				new TestRunnerWindow().setVisible(true);
			}
		});
	}
